      ...
      <div className="container-custom">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <a href="mailto:contact@tickettime.com" className="text-gray-400 hover:text-white transition-colors">
                  contact@tickettime.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone size={18} className="mr-2 text-gray-400" />
                <a href="tel:+212 704 29 34 16" className="text-gray-400 hover:text-white transition-colors">
                  +212 704 29 34 16
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <p className="text-center text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Ticket Time. Tous droits réservés. Projet de fin d'études par Ayoub et Amine.
          </p>
        </div>
      </div>
    </footer>
